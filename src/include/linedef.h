...
typedef enum {
  ...
  /*  */
  LINEDEF_FREESTANDING = M_BIT(5),

  LINEDEF_PIN_TEXTURES = LINEDEF_PIN_TOP_TEXTURE | LINEDEF_PIN_BOTTOM_TEXTURE,
  LINEDEF_TRANSPARENT_WALL = LINEDEF_TRANSPARENT_MIDDLE_TEXTURE | LINEDEF_DOUBLE_SIDED,
  LINEDEF_STATIC_DETAIL = LINEDEF_FREESTANDING | LINEDEF_DOUBLE_SIDED
} linedef_flags;
